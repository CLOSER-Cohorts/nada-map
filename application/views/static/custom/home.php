...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 mb-4">
        <div class="ui-tabs wb-tab-heading mb-1">
            <!-- *****  Map filters ***** -->
            <?php $this->map_viewer->renderFilters(); ?>
        </div>
        <div>
            <!-- *****  Map ***** -->
            <?php $this->map_viewer->renderMap(); ?>
        </div>
    </div>
